...
import { MapPin, Calendar, X, MessageSquare, Send, CheckCircle2, Phone, Hash, ShieldCheck, RefreshCw } from 'lucide-react';
...
export default function ItemDetailsModal({ item, onClose, onResolve }: ItemDetailsModalProps) {
  ...
  const handleResolve = async (e: React.MouseEvent) => {
    ...
    if (!window.confirm(` Are you sure you want to ${actionText}? This will remove it from the database.`)) return;
      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        >
          <div className="flex flex-col lg:flex-row">
            ...
            {/* Content Side */}
            <div className="flex flex-1 flex-col p-6 sm:p-8 lg:p-12 overflow-y-auto max-h-[85vh]">
